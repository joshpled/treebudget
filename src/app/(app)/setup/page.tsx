    ...
    <>
      ...
      <section className="px-4 pb-4">
        <div className="rounded-2xl border border-border bg-surface p-4 shadow-card">
          <h2 className="text-[14px] font-semibold text-ink">How it works</h2>
          <p className="mt-1.5 text-[13px] leading-relaxed text-muted">
            treebudget tracks three buckets — <strong>Bills</strong>,{" "}
            <strong>Spending</strong>, and <strong>Savings</strong> — and
            applies your split to every income you tag. The app does the math,
            but it can&apos;t move real money for you. To make the buckets
            real, you separate your accounts at your bank and let your
            paycheck split itself there too. Once set up, it&apos;s
            hands-off forever.
          </p>
          <p className="mt-2 text-[13px] leading-relaxed text-muted">
            If you&apos;d rather just use treebudget as a budget tracker on
            one account, that works too — skip the steps below and treat the
            Spending balance as your weekly allowance.
          </p>
        </div>
      </section>
